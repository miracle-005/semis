...
//     e.preventDefault();
//     var t=o(e.target).find("input[type=text].form-control-main"),a=t.val();
//     if (!a.trim()) return;  // Do nothing if message is empty
//
//     n({type:"out", text: a});  // Keeps the sent message UI update
//     t.val("");  // Clears input
//     o(".chat .chat-body").scrollTop(o(".chat .chat-body")[0].scrollHeight);  // Scrolls to latest message
